...
```bash
# Download AppImage
wget https://github.com/TatsumiDaku/engram-desktop-view/releases/latest/download/EngramDesktopView-1.3.3.AppImage
...
sudo dnf install EngramDesktopView-1.3.3.x86_64.rpm
...
```bash
# Run with X11
ELECTRON_OZONE_PLATFORM_HINT=auto ./EngramDesktopView-1.3.3.AppImage
```
